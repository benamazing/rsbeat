...
rm -rf vendor
mkdir -p vendor
curl -fsSL "https://github.com/elastic/beats/archive/v5.3.2.tar.gz" -o vendor/beats-v5.3.2.tar.gz
...
tar zxf vendor/beats-v5.3.2.tar.gz -C ${GOPATH}/src/github.com/elastic
mv ${GOPATH}/src/github.com/elastic/beats-5.3.2 ${GOPATH}/src/github.com/elastic/beats
